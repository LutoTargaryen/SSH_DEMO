...
<body>
	<fieldset>
		...
		<form action="${pageContext.request.contextPath }/stu/studentAction/updateStudent.do" method="post">
			<s:hidden name="student.stuId"/>
			<s:textfield label="姓名" name="student.stuName" />
			<s:radio label="性别" name="student.stuSex" list="{'男','女'}" />
